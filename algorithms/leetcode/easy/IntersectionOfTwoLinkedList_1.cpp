...
public:
    ListNode *getIntersectionNode(ListNode *headA, ListNode *headB) {
        ...
        // [idea]
        // iterate through list A, reverse it.
        // then iterate list B, if the iterator reachs head of list A, that means there exist a intersection
        // but we still don't know where's the intersection
        // :(

        // [idae]
        // use hash table (key = node addr)
        ...
        while (iteratorA != NULL || iteratorB != NULL) {
            ...
            if (iteratorA != NULL) {
                ...
                if (visited.count(iteratorA) > 0) {

                    return iteratorA;
                
                } else {
                    visited[iteratorA] = true;
                }
            ...
            if (iteratorB != NULL) {
                ...
                if (visited.count(iteratorB) > 0) {

                    return iteratorB;
                
                } else {
                    visited[iteratorB] = true;
                }
